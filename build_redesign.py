...
.rail__sum{margin-top:7px;font-family:var(--mono);font-size:11.8px;color:var(--ink-3);line-height:1.55}
.rail__role{margin-top:11px;font-size:15px;color:var(--ink);line-height:1.4;letter-spacing:-0.008em}
...
.tile__badge{font-family:var(--mono);font-size:12.3px;color:var(--ink);background:var(--sunk);
  padding:9px 11px;line-height:1.65}
...
.sheet__badge{font-family:var(--mono);font-size:13px;background:var(--sunk);
  padding:10px 12px;line-height:1.7;margin-bottom:12px}
...
.body .metric{font-family:var(--mono);font-size:13px;background:var(--sunk);
  padding:10px 12px;line-height:1.7;margin:0 0 14px;color:var(--ink)}
...
<aside class="rail">
  ...
  <p class="rail__sum">Graduate data science student &middot; Syracuse University</p>
  <p class="rail__role">I build retrieval, evaluation, and streaming data systems, then measure
  ...
  <div class="rail__c">
    ...
    <span>Syracuse, NY<br>Open to data, ML, AI, and analytics roles</span>
  </div>
</aside>
